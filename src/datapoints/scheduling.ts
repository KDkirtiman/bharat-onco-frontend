...
export const APPOINTMENT_STATUS_CONFIG: Record<string, { label: string; className: string }> = {
  ...
  'vitals-in-progress':          { label: 'Vitals In Progress',      className: 'bg-teal-50 text-teal-700'           },
  'vitals-recorded':             { label: 'Vitals Recorded',         className: 'bg-teal-100 text-teal-700'          },
  'chemo-checklist-in-progress': { label: 'Pre-Checklist Active',    className: 'bg-amber-100 text-amber-700'        },
  'checklist-completed':         { label: 'Checklist Done',          className: 'bg-purple-100 text-purple-700'      },
  'consult-in-progress':         { label: 'Consult In Progress',     className: 'bg-violet-100 text-violet-700'      },
  'staging-in-progress':         { label: 'Staging In Progress',     className: 'bg-purple-100 text-purple-700'      },
  'deciding-treatment-plan':     { label: 'Deciding Treatment Plan', className: 'bg-indigo-100 text-indigo-700'      },
  'chemo-auth-pending':          { label: 'Chemo Auth Pending',      className: 'bg-amber-50 text-amber-700'         },
  'chemo-auth-rejected':         { label: 'Chemo Auth Rejected',     className: 'bg-red-100 text-red-700'            },
  'waiting-chair-assignment':    { label: 'Waiting Chair',           className: 'bg-sky-100 text-sky-700'            },
  'chair-assigned':              { label: 'Chair Assigned',          className: 'bg-indigo-100 text-indigo-700'      },
